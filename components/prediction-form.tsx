...
const initialPredictionState: PredictionData = {
  rainfall: "",
  temperature: "",
  humidity: "",
  soilType: "",
...
export function PredictionForm() {
  const [formData, setFormData] = useState<PredictionData>(initialPredictionState)
  ...
  const handleResetForm = () => {
    setFormData(initialPredictionState)
    setPrediction(null)
    setError(null)
  }

  const formIsEmpty = Object.values(formData).every((value) =>
  ...
  return (
    <div className="space-y-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="flex flex-col gap-3 pt-4 mt-4 border-t border-green-100 sm:flex-row sm:justify-end sm:items-center">
          <button
            type="button"
